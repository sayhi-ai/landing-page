...
export default class VarietyCodeSection extends React.Component {
            ...
            <PageContainer styles={styles}>
                ...
                <div className="vcp-content">
                    <div className="vcp-explanation">
                        ...
                        hard-coding answers, use our service to generate diverse
                        responses so that your customers never get bored again.
                    </div>
                </div>
